...
const HW_PROFILES = {
  gcp: {
    h100: {
      ...
      type: "PUBLIC_PRICE",
      priceNote:
        "Approx. public on-demand. DWS calendar/flex-start are cheaper but capacity scheduled.",
    },
    h200: {
      id: "h200",
      name: "H200 (A3 Ultra)",
      ...
      priceNote:
        "Using GCP DWS Calendar price. Flex-start is cheaper but less schedulable.",
    },
    b200: {
      id: "b200",
      name: "B200 (A4)",
    ...
    gb200: {
      ...
      priceNote:
        "External GB200 NVL72 market proxy from CoreWeave. Google A4X still requires quote/reservation.",
    },
    gb300: {
      id: "gb300",
      name: "GB300 (A4X Max)",
      ...
      priceNote:
        "No reliable public hourly price. Rack-cost estimates are too uncertain for calculator use.",
    },
  },
  hf: {
    a100: {
    ...
    custom: {
      ...
      type: "INFERRED_REQUIRES_QUOTE",
      priceNote:
        "HF custom cluster estimate. Low anchor = H200 Jobs; high anchor = historical HF DGX Cloud H100 training.",
    },
  },
  deepinfra: {
    b200: {
    ...
    h100_ded: {
      ...
      type: "INFERRED_REQUIRES_QUOTE",
      priceNote:
        "DeepInfra public dedicated H100 GPU-hour signal; large training cluster still requires sales confirmation.",
    },
    b300_ded: {
      id: "b300_ded",
      name: "B300 Dedicated",
      ...
      minGPUs: 256,
      priceNote:
        "DeepInfra DeepCluster 3-year B300 price. Requires 256–5,000 GPU dedicated cluster and 3–5 year term.",
    },
  },
};
...
const AVAILABILITY = {
  gcp: {
    h100: {
      status: "PUBLIC_CAPACITY_CONTROLLED",
      title: "Documented training hardware",
      note: "A3 H100 is documented for training workloads, but large node counts still depend on quota, region, reservation, and capacity.",
    },
    h200: {
      status: "PUBLIC_CAPACITY_CONTROLLED",
      title: "GA, capacity-controlled",
      note: "A3 Ultra H200 is documented for foundation-model training. Provisioning requires reservation, Spot, Flex-start, or MIG resize request.",
    },
    b200: {
      status: "PUBLIC_CAPACITY_CONTROLLED",
      title: "Documented Blackwell training hardware",
      note: "A4 B200 is documented for foundation-model training. Treat large clusters as capacity-controlled, not instant self-serve.",
    },
    gb200: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Reserved enterprise capacity",
      note: "A4X GB200 is documented and requires reserved capacity. For real projects, pricing and availability go through Google capacity planning.",
    },
    gb300: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Bare-metal reserved capacity",
      note: "A4X Max GB300 is documented as bare metal and requires reserved capacity. Treat it as enterprise/custom, not normal hourly GPU rental.",
    },
  },
  hf: {
    a100: {
      status: "PUBLIC_SELF_SERVE",
      title: "Public Jobs SKU",
      note: "HF Jobs has public A100 pricing up to 8 GPUs. Good for experiments and fine-tuning; many-node pretraining is not proven by the Jobs table.",
    },
    h200: {
      status: "PUBLIC_SELF_SERVE",
      title: "Public Jobs SKU",
      note: "HF Jobs has public H200 pricing up to 8 GPUs. Larger H200 clusters belong in the Training Cluster waitlist/custom path.",
    },
    h100: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Training Cluster only",
      note: "HF Training Cluster exposes H100 through a waitlist/custom request flow. Do not model it as public Jobs pricing.",
    },
    b200: {
      status: "NO_PUBLIC_EVIDENCE",
      title: "No public HF training SKU found",
      note: "I found no current public HF Jobs or Training Cluster selector for B200 training.",
    },
    gb200: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Possible through DGX Cloud ecosystem, not self-serve",
      note: "HF/NVIDIA announcements mention GB200 via DGX Cloud Lepton ecosystem, but the current HF Training Cluster selector exposes H100/H200. Treat GB200 as custom only.",
    },
    gb300: {
      status: "NO_PUBLIC_EVIDENCE",
      title: "No public HF GB300 training product found",
      note: "Do not show GB300 as available on Hugging Face unless manually marked as custom quote.",
    },
    custom: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Custom Training Cluster",
      note: "HF Training Cluster is a waitlist/custom sourcing flow. Capacity, provider, region, duration, and price are negotiated.",
    },
  },
  deepinfra: {
    b200: {
      status: "PUBLIC_SELF_SERVE",
      title: "Public B200 GPU Instances",
      note: "DeepInfra publicly documents dedicated B200 GPU Instances for training, fine-tuning, and custom workloads. Large multi-node availability is still not guaranteed.",
    },
    h100_ded: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Dedicated deployment, custom training capacity",
      note: "DeepInfra mentions dedicated H100 deployments, but public docs do not prove large self-serve H100 training clusters.",
    },
    h200_ded: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Dedicated deployment, custom training capacity",
      note: "DeepInfra mentions dedicated H200 deployments, but public docs do not prove large self-serve H200 training clusters.",
    },
    b200_ded: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "B200 cluster by sales/custom capacity",
      note: "DeepInfra docs mention B200 clusters with SSH, but not public 512-node B200 availability.",
    },
    b300_ded: {
      status: "CUSTOM_WAITLIST_OR_SALES",
      title: "Public DeepCluster offer, long-term dedicated",
      note: "DeepInfra DeepCluster is B300, 256–5,000 GPUs, 3–5 year terms. This is dedicated infrastructure, not self-serve hourly cloud.",
    },
    gb200: {
      status: "NO_PUBLIC_EVIDENCE",
      title: "No public DeepInfra GB200 product found",
      note: "Do not mark GB200 available for DeepInfra based on current public docs.",
    },
    gb300: {
      status: "NO_PUBLIC_EVIDENCE",
      title: "No public DeepInfra GB300 product found",
      note: "DeepInfra documents B300, not GB300. These are different architectures/products.",
    },
  },
};
...
export default function App() {
  ...
  const currentEfficiency =
    mode === "lora" ? loraEfficiency : pretrainEfficiency;
  ...
  const baseFlopsPerSec =
    mode === "lora"
      ? hwProfile.tflops * 1_000_000_000_000
      : hwProfile.tflops * 1_000_000_000_000 * hwProfile.gpusPerNode;

  const flopsPerToken =
    mode === "lora" ? FLOPS_PER_TOKEN_LORA : FLOPS_PER_TOKEN_PRETRAIN;
  const theoreticalTokensPerSecPerUnit = baseFlopsPerSec / flopsPerToken;
  const actualTokensPerSecPerUnit =
    theoreticalTokensPerSecPerUnit * (currentEfficiency / 100);
  ...
  const activePricePerGPU =
    spotEligible && useSpot ? hwProfile.spot : hwProfile.price;
  const activePricePerNode =
    activePricePerGPU !== null
      ? activePricePerGPU * hwProfile.gpusPerNode
      : null;
  ...
  const generateInsights = () => {
    ...
    if (mode === "lora") {
      insights.push({
        icon: "🧠",
        text: `Frozen Base Weights: Only training a tiny adapter network, but computing gradients still requires passing through the frozen model (~4x FLOPs per token).`,
      });
    } else {
      insights.push({
        icon: "🔥",
        text: "Unfrozen Weights: All 31B parameters of the Dense model are being updated. Every token requires ~186 Billion operations.",
      });
      if (
        currentDataGB >= 25000 &&
        currentCompute >= 24 &&
        ...
        insights.push({
          icon: "🇺🇦",
          text: "Syaivo Scale: Training on dozens of terabytes across ~32 nodes mirrors the Diia AI Factory setup. Local data sovereignty requires extended runtimes.",
        });
      }
    }
    ...
    if (provider === "gcp") {
      if (mode === "lora") {
        if (useSpot) {
          insights.push({
            icon: "✅",
            text: `Spot Viability: LoRA checkpoints are fast enough to absorb high preemption rates, making it operationally viable to use Spot instances.`,
          });
        }
      } else {
        insights.push({
          icon: "🚨",
          text: `Spot is a no-go: A single preempted node can interrupt a conventional synchronized training run unless the stack supports elastic recovery and checkpoint restart.`,
        });
      }
    }
    ...
    if (provider === "hf") {
      if (hwProfile.id === "custom") {
        insights.push({
          icon: "🤗",
          text: `Capacity: Hugging Face Training Clusters for large-scale pretraining require custom quotes and waitlist negotiations. Do not assume on-demand capacity.`,
        });
      } else {
        insights.push({
          icon: "🤗",
          text: `Platform Architecture: Hugging Face Jobs provides solid public pricing for ${hwProfile.name}, excellent for managed training jobs and fine-tuning.`,
        });
      }
    }
    ...
    if (provider === "deepinfra") {
      if (hwProfile.id === "b200") {
        insights.push({
          icon: "⚡",
          text: `Self-Serve: DeepInfra's B200 GPU Instances are ideal for highly cost-effective fine-tuning and training experiments without enterprise overhead.`,
        });
      } else {
        insights.push({
          icon: "🚧",
          text: `Availability: Large Dedicated ${hwProfile.name} clusters require contacting sales.`,
        });
      }
    }
      ...
      <div className="max-w-5xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="flex flex-col space-y-3">
            <label className="font-semibold text-slate-700 text-sm uppercase tracking-wider">
              Training Objective
            </label>
            <div className="flex flex-col sm:flex-row bg-slate-100 p-1 rounded-xl w-full">
              ...
              >
                ...
                <div className="text-xs opacity-75 font-normal mt-0.5">
                  Adjust style/format (Frozen Weights)
                </div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-xs opacity-75 font-normal mt-0.5">
                  Integrate new language (Unfrozen Weights)
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-slate-50 p-6 rounded-xl border border-slate-100">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  mode === "lora"
                    ? setLoraDataGB(Number(e.target.value))
                    : setPretrainDataGB(Number(e.target.value))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  mode === "lora"
                    ? setLoraGPUs(Number(e.target.value))
                    : setPretrainNodes(Number(e.target.value))
                }
                className="w-full h-2 bg-slate-300 rounded-lg appearance-none cursor-pointer accent-slate-800"
              />
              <p className="text-xs text-slate-500 mt-2">
                {mode === "lora"
                  ? "Individual GPUs"
                  : `1 Node = ${hwProfile.gpusPerNode}x GPUs`}
              </p>
            </div>
            ...
            <div>
              <div className="flex justify-between items-end mb-4">
                ...
                <span
                  className={`text-lg font-bold px-3 py-1 rounded-md ${currentEfficiency < 50 ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700"}`}
                >
                  {currentEfficiency}%
                </span>
              </div>
              <input
                ...
                onChange={(e) =>
                  mode === "lora"
                    ? setLoraEfficiency(Number(e.target.value))
                    : setPretrainEfficiency(Number(e.target.value))
                }
                className="w-full h-2 bg-slate-300 rounded-lg appearance-none cursor-pointer accent-slate-800"
              />
              <p className="text-xs text-slate-500 mt-2">
          ...
          <div className="bg-slate-100 p-5 rounded-xl border border-slate-200 space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  { id: "hf", name: "Hugging Face", sub: "Jobs / Clusters" },
                  {
                    id: "deepinfra",
                    name: "DeepInfra",
                    sub: "Instances / Clusters",
                  },
                ].map((prov) => (
                  <label
                    key={prov.id}
                    className={`flex items-center p-3 border rounded-lg cursor-pointer transition-all ${provider === prov.id ? "bg-blue-50 border-blue-400 ring-1 ring-blue-400" : "bg-white border-slate-200 hover:bg-slate-50"}`}
                  >
                    <input
                      type="radio"
                      name="provider"
            ...
            <div className="pt-4 border-t border-slate-200">
              <div className="flex justify-between items-center mb-3">
                <h4 className="font-bold text-slate-800 text-sm">
                  2. Select Hardware Architecture
                </h4>
                {provider === "gcp" &&
                  mode === "lora" &&
                  hwProfile.spot !== null && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100">
            <div className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm flex flex-col justify-center items-center text-center">
              ...
              <span className="text-xs text-slate-400 mt-1">
                across {epochs} {epochs === 1 ? "epoch" : "epochs"}
              </span>
            </div>
            ...
            <div
              className={`border p-5 rounded-xl shadow-sm flex flex-col justify-center items-center text-center transition-colors ${estimatedCost === null ? "bg-slate-50 border-slate-200" : mode === "lora" ? "bg-blue-50 border-blue-200" : "bg-purple-50 border-purple-200"}`}
            >
              <span
                className={`text-sm font-semibold uppercase tracking-wider mb-2 ${estimatedCost === null ? "text-slate-600" : mode === "lora" ? "text-blue-600" : "text-purple-600"}`}
              >
                Est. Cloud Cost
              </span>
              <span
                className={`text-3xl font-bold ${estimatedCost === null ? "text-slate-800" : mode === "lora" ? "text-blue-700" : "text-purple-700"}`}
              >
                {formatCostDisplay(estimatedCost)}
              </span>
              <span
                className={`text-xs mt-1 px-4 leading-tight ${estimatedCost === null ? "text-slate-500" : mode === "lora" ? "text-blue-500/80" : "text-purple-500/80"}`}
              >
                {estimatedCost === null
          ...
          <div className="bg-slate-800 text-slate-200 rounded-xl p-5 text-sm leading-relaxed shadow-inner border border-slate-700">
            <h3 className="text-white font-bold mb-4 uppercase tracking-wider text-xs border-b border-slate-600 pb-2">
              Live Infra Insights & Availability
            </h3>
